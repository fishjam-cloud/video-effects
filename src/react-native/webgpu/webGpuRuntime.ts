...
export function getWebGpuRuntime(): WebGpuRuntime {
  if (typeof RNWebGPU === "undefined") {
    ...
    if (!installedOk || typeof RNWebGPU === "undefined") {
      throw new Error(
        "@fishjam-cloud/video-effects: the RNWebGPU global is missing and WebGPUModule.install() " +
    ...
    console.warn(
      "@fishjam-cloud/video-effects: the RNWebGPU global was missing on this runtime; re-ran install()",
    );
  }
  return RNWebGPU;
}
